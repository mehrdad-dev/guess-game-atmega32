...
_0x0:
	...
	.DB  0x47,0x61,0x6D,0x65,0x20,0x2E,0x2E,0x2E
	.DB  0x0,0x59,0x6F,0x75,0x20,0x47,0x6F,0x74
	.DB  0x20,0x49,0x74,0x21,0x20,0x20,0x20,0x20
	.DB  0x20,0x0,0x2D,0x2D,0x2D,0x2D,0x2D,0x2D
	.DB  0x2D,0x2D,0x2D,0x2D,0x2D,0x2D,0x2D,0x2D
	.DB  0x2D,0x2D,0x0,0x41,0x6E,0x73,0x77,0x65
	.DB  0x72,0x20,0x49,0x73,0x3A,0x20,0x25,0x64
	.DB  0x0,0x53,0x6F,0x20,0x43,0x6C,0x6F,0x73
	.DB  0x65,0x21,0x20,0x20,0x20,0x20,0x20,0x0
	.DB  0x43,0x6C,0x6F,0x73,0x65,0x21,0x20,0x20
	.DB  0x20,0x20,0x20,0x20,0x20,0x0,0x46,0x61
	.DB  0x72,0x21,0x20,0x20,0x20,0x20,0x20,0x20
	.DB  0x20,0x20,0x0,0x53,0x6F,0x20,0x46,0x61
	.DB  0x72,0x21,0x20,0x20,0x20,0x20,0x20,0x20
	.DB  0x20,0x20,0x0,0x57,0x65,0x6C,0x63,0x6F
	.DB  0x6D,0x65,0x20,0x54,0x6F,0x0,0x47,0x75
	.DB  0x65,0x73,0x73,0x20,0x47,0x61,0x6D,0x65
	.DB  0x0,0x50,0x72,0x65,0x73,0x73,0x20,0x3D
	.DB  0x20,0x74,0x6F,0x20,0x73,0x74,0x61,0x72
	.DB  0x74,0x0,0x4E,0x75,0x6D,0x62,0x65,0x72
...
; 0000 005A                     num_holder[num_index] = ch;
	MOVW R30,R12
	SUBI R30,LOW(-_num_holder)
	SBCI R31,HIGH(-_num_holder)
	ST   Z,R5
; 0000 005B                     num_counter++;
	LDI  R26,LOW(_num_counter)
	LDI  R27,HIGH(_num_counter)
	CALL SUBOPT_0x2
; 0000 005C                     num_index++;
	MOVW R30,R12
	ADIW R30,1
...
; 0000 005E                     current_number = atoi(num_holder);     // convert to int
	LDI  R26,LOW(_num_holder)
	LDI  R27,HIGH(_num_holder)
	CALL _atoi
	MOVW R10,R30
; 0000 005F 
...
; 0000 00AC         if  (num_index >= no_of_digits)  {
	LDS  R30,_no_of_digits
	LDS  R31,_no_of_digits+1
	CP   R12,R30
	CPC  R13,R31
	BRLT _0x28
; 0000 00AD             ch = ch;
...
; 0000 00CC             srand(++seed_time);
	LDI  R26,LOW(_seed_time)
	LDI  R27,HIGH(_seed_time)
	CALL SUBOPT_0x2
	MOVW R26,R30
	CALL _srand
...
SUBOPT_0x9:
	...
	__PUTB1MN _buffer,3
	LDI  R30,LOW(0)
	STS  _num_counter,R30
	STS  _num_counter+1,R30
	RET
